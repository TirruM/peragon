...
export class SigninComponent implements OnInit {
  ...
  constructor(
    ...
    private sharedService: BroadcastserviceService
  ) {
    this.loadLoginForm(fb);
  }
  ...
  public login() {
    ...
    if (
      this.loginForm.value.email === "buyer@gmail.com" &&
      this.loginForm.value.password === "buyer"
    ) {
      headerHideValues = {
        dropDown: true,
        btns: false
      ...
      this.loginForm.value.email === "seller@gmail.com" &&
      this.loginForm.value.password === "seller"
    ) {
      headerHideValues = {
        dropDown: false,
        btns: false
